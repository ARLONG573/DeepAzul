...
public class AzulState implements GameState {
	...
	/**
	 * This constructor is used to create a fresh game state from which to start a
	 * new game of Azul. All successive AzulState objects should be generated by
	 * using the copy constructor and making moves to the copy.
	 * 
	 * @param numPlayers
	 *            The number of players to play
	 * @param firstPlayer
	 *            The id of the player to go first
	 */
	public AzulState(final int numPlayers, final int firstPlayer) {
